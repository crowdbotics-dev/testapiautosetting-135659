...
class Testconnectors135659ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS135659_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS135659_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS135659"
